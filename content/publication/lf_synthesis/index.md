...
abstract_short = "Spotlight Presentation in *ICCV 2017*. Deep networks can promote a single image to a local neighborhood of views and depth maps."
...
url_custom = [{name = "Paper on Arxiv", url = "https://arxiv.org/abs/1708.03292"},{name = "Supplementary PDF", url = "https://people.eecs.berkeley.edu/~pratul/ICCV17_LF_Synthesis_Supplementary.pdf"}]
